...
const createPlan = {
  body: Joi.object().keys({
    ...
    roiType: Joi.string().valid("daily", "weekly", "monthly", "total").default("daily"),
    duration: Joi.number().required().min(1),
    durationType: Joi.string().valid("hours", "days", "weeks", "months").default("days"),
...
const updatePlan = {
  ...
  body: Joi.object()
    .keys({
      ...
      roiType: Joi.string().valid("daily", "weekly", "monthly", "total"),
      duration: Joi.number().min(1),
      durationType: Joi.string().valid("hours", "days", "weeks", "months"),
